...
export default function Navbar() {
  ...
  return (
    <div className="flex justify-center items-center">
      <header
        className={`relative flex min-h-[100px] w-full items-center max-w-[1440px] justify-between gap-8 px-4 sm:px-8 text-sm font-bold leading-none text-white lg:px-[100px]`}
      >
        {/* Logo */}
